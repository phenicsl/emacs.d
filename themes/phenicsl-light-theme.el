...
(let ((phenicsl-orange-1 "#D75A4F")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((t (:foreground "#414E9E" :weight bold))))
   `(font-lock-function-name-face ((t (:foreground "#414E9E" :weight bold))))
   ...
   `(font-lock-type-face ((t (:foreground  "#4F914F" :weight bold))))
